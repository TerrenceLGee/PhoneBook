...
{
    Task<Result> AddContactAsync(string name, string phoneNumber, string? email, string? address, string category, string country);
    Task<Result> UpdateContactAsync(int id, string name, string phoneNumber, string? email, string? address, string category, string country);
